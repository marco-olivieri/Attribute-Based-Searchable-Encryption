/* 
script che esegue automaticamente run di processi in parallelo,
secondo un vettore generato v_proc. Ciascun processo, quando termina,
stampa a video il proprio tempo di esecuzione. L'output del terminale può essere salvato
ed opportunamente analizzato con Python/Matlab 
*/
...
creare cartella bin per i file binari e, aprendo il terminale nella cartella con il file C, compilare con comando:
gcc -o bin/search_sim search_sim.c -L. -lm -lgmp -lpbc
...
./bin/search_sim <~/.../pbc-0.5.14/param/<file>.param
